...
export class LayoutComponent {
  ...
  backofficeMenuItems: MenuItem[] = [
    ...
    {
      id: 'session-calendar',
      label: 'Calendrier séances',
      icon: 'event_available',
      routerLink: '/backoffice/session-calendar'
    },
    { id: 'streams', label: 'Live Streams', icon: 'live_tv', routerLink: '/backoffice/streams' },
    { id: 'recordings', label: 'Recordings', icon: 'video_library', routerLink: '/backoffice/recordings' },
