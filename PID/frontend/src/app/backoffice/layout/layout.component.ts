...
import { TutorDmNotifierService } from '../../services/tutor-dm-notifier.service';
...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  backofficeMenuItems: MenuItem[] = [
    ...
    /** Bloc aligné sur la maquette : Clubs → Forum → Modération */
    ...
    { id: 'sec-admin', label: 'Administration', icon: 'admin_panel_settings', routerLink: '', kind: 'section' },
    ...
    { id: 'streams', label: 'Streaming Management', icon: 'live_tv', routerLink: '/backoffice/streams' },
    { id: 'recordings', label: 'Recordings Management', icon: 'video_library', routerLink: '/backoffice/recordings' },
    { id: 'session-calendar', label: 'Session Calendar', icon: 'calendar_month', routerLink: '/backoffice/session-calendar' },
    { id: 'evaluations', label: 'Evaluations', icon: 'quiz', routerLink: '/backoffice/evaluations' },
