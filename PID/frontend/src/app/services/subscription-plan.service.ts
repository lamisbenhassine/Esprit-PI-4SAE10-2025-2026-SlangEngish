...
import { API_URL as API_ROOT } from '../api.config';

/** Toujours via la gateway (8100) ou la même base que cart/orders — pas d’URL relative /api sur :4200. */
const API_URL = `${API_ROOT}/inscription/plans`;
