...
public interface UserService {
    ...
    /** Connexion par email + empreinte faciale (si un modèle a été enregistré à l'inscription). */
    User signinFace(SigninFaceRequest request);

    /** Connexion par visage seul : meilleure correspondance parmi les comptes ayant une empreinte. */
    User signinFaceOnly(SigninFaceOnlyRequest request);
