...
public class AuthController {
    ...
    public ResponseEntity<UserResponse> signinFace(@Valid @RequestBody SigninFaceRequest request) {
        User user = userService.signinFace(request);
        return ResponseEntity.ok(UserResponse.fromEntity(user));
    }

    @PostMapping("/signin-face-only")
    public ResponseEntity<UserResponse> signinFaceOnly(@Valid @RequestBody SigninFaceOnlyRequest request) {
        User user = userService.signinFaceOnly(request);
        return ResponseEntity.ok(UserResponse.fromEntity(user));
    }
